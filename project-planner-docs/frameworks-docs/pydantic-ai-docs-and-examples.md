...
- Only files matching these patterns are included: docs/**/*.md, examples/**/*
...
## File: examples/pydantic_ai_examples/evals/datasets/time_range_v1_schema.json
````json
{
  "$defs": {
    "Case": {
...
## File: examples/pydantic_ai_examples/evals/datasets/time_range_v1.yaml
````yaml
...
## File: examples/pydantic_ai_examples/evals/datasets/time_range_v2_schema.json
````json
{
  "$defs": {
    "Case": {
...
## File: examples/pydantic_ai_examples/evals/datasets/time_range_v2.yaml
````yaml
...
## File: examples/pydantic_ai_examples/evals/example_01_generate_dataset.py
````python
import asyncio
from pathlib import Path
...
## File: examples/pydantic_ai_examples/evals/example_02_add_custom_evaluators.py
````python
from pathlib import Path
from types import NoneType
...
## File: examples/pydantic_ai_examples/evals/example_03_unit_testing.py
````python
from pathlib import Path
from types import NoneType
...
## File: examples/pydantic_ai_examples/evals/example_04_compare_models.py
````python
from pathlib import Path
from types import NoneType
...
## File: examples/pydantic_ai_examples/evals/models.py
````python
from __future__ import annotations as _annotations
